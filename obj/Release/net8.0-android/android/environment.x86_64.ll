...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100671134, ; uint32_t jnienv_initialize_method_token (0x6001e9e)
	i32 100671133, ; uint32_t jnienv_registerjninatives_method_token (0x6001e9d)
...
@dso_cache = dso_local local_unnamed_addr global [628 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.61_name, ; name: libaot-Xamarin.GooglePlayServices.Maps.dll.so
		ptr null; void* handle (0x0)
	}, ; 25
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.66_name, ; name: libaot-ZXing.Net.MAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-Microsoft.Maui.Maps.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.58_name, ; name: libaot-Xamarin.Google.Guava.ListenableFuture.dll.so
		ptr null; void* handle (0x0)
	}, ; 61
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.33_name, ; name: libaot-Xamarin.AndroidX.Camera.Lifecycle.dll.so
		ptr null; void* handle (0x0)
	}, ; 63
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.67_name, ; name: libaot-ZXing.Net.MAUI.Controls.dll.so
		ptr null; void* handle (0x0)
	}, ; 89
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.65_name, ; name: libaot-zxing.dll.so
		ptr null; void* handle (0x0)
	}, ; 107
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-Xamarin.AndroidX.Camera.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 119
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4499496351762386583, ; hash 0x3e716c17b2f68e97, from name: libaot-MetanetA_MobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 147
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Microsoft.Maui.Controls.Maps.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10895889083939526533, ; hash 0x9735f96498459785, from name: MetanetA_MobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 359
	%struct.DSOCacheEntry {
		i64 10904992116657869159, ; hash 0x9756508d8fd3d167, from name: aot-MetanetA_MobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 360
	...
	%struct.DSOCacheEntry {
		i64 11325997426508396790, ; hash 0x9d2e06a6d60578f6, from name: libaot-MetanetA_MobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 375
	...
	%struct.DSOCacheEntry {
		i64 14437941549388880843, ; hash 0xc85ddf57fb2d5bcb, from name: MetanetA_MobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 489
	...
	%struct.DSOCacheEntry {
		i64 17694084317623069094, ; hash 0xf58e03f089bba9a6, from name: aot-MetanetA_MobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 596
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6154c040-3b69-4781-998e-e7741d58a814\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [35 x i8] c"com.companyname.metaneta_mobileapp\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [33 x i8] c"libaot-MetanetA_MobileApp.dll.so\00", align 16
...
@.DSOCacheEntry.22_name = private unnamed_addr constant [43 x i8] c"libaot-Microsoft.Maui.Controls.Maps.dll.so\00", align 16
...
@.DSOCacheEntry.27_name = private unnamed_addr constant [34 x i8] c"libaot-Microsoft.Maui.Maps.dll.so\00", align 16
...
@.DSOCacheEntry.32_name = private unnamed_addr constant [43 x i8] c"libaot-Xamarin.AndroidX.Camera.Core.dll.so\00", align 16
@.DSOCacheEntry.33_name = private unnamed_addr constant [48 x i8] c"libaot-Xamarin.AndroidX.Camera.Lifecycle.dll.so\00", align 16
...
@.DSOCacheEntry.58_name = private unnamed_addr constant [52 x i8] c"libaot-Xamarin.Google.Guava.ListenableFuture.dll.so\00", align 16
...
@.DSOCacheEntry.61_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Maps.dll.so\00", align 16
...
@.DSOCacheEntry.65_name = private unnamed_addr constant [20 x i8] c"libaot-zxing.dll.so\00", align 16
@.DSOCacheEntry.66_name = private unnamed_addr constant [29 x i8] c"libaot-ZXing.Net.MAUI.dll.so\00", align 16
@.DSOCacheEntry.67_name = private unnamed_addr constant [38 x i8] c"libaot-ZXing.Net.MAUI.Controls.dll.so\00", align 16
