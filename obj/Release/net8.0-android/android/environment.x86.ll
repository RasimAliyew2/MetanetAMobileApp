...
@dso_cache = dso_local local_unnamed_addr global [628 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 102536510, ; hash 0x61c953e, from name: aot-MetanetA_MobileApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 274232372, ; hash 0x10587434, from name: MetanetA_MobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 37
	...
	%struct.DSOCacheEntry {
		i64 453251388, ; hash 0x1b04113c, from name: libaot-MetanetA_MobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 61
	...
	%struct.DSOCacheEntry {
		i64 1779983584, ; hash 0x6a1864e0, from name: libaot-MetanetA_MobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 245
	...
	%struct.DSOCacheEntry {
		i64 2151299375, ; hash 0x803a392f, from name: aot-MetanetA_MobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 307
	...
	%struct.DSOCacheEntry {
		i64 2987996059, ; hash 0xb219339b, from name: MetanetA_MobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MetanetA_MobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
